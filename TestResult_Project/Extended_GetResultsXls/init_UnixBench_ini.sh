...
\cp $pointsFile_1thread $destPath/${TestCase}_1_BASELINE_${Node_num}.ini -f

pointsFile_1thread="$curPointsIniDir/${TestCase}_1thread_RESULT.ini"
\cp $pointsFile_1thread $destPath/${TestCase}_1_RESULT_${Node_num}.ini -f

pointsFile_1thread="$curPointsIniDir/${TestCase}_1thread_INDEX.ini"
\cp $pointsFile_1thread $destPath/${TestCase}_1_INDEX_${Node_num}.ini -f

#2线程
pointsFile_2thread="$curPointsIniDir/${TestCase}_2thread_BASELINE.ini"
\cp $pointsFile_2thread $destPath/${TestCase}_2_BASELINE_${Node_num}.ini -f

pointsFile_2thread="$curPointsIniDir/${TestCase}_2thread_RESULT.ini"
\cp $pointsFile_2thread $destPath/${TestCase}_2_RESULT_${Node_num}.ini -f

pointsFile_2thread="$curPointsIniDir/${TestCase}_2thread_INDEX.ini"
\cp $pointsFile_2thread $destPath/${TestCase}_2_INDEX_${Node_num}.ini -f

#4线程
pointsFile_4thread="$curPointsIniDir/${TestCase}_4thread_BASELINE.ini"
\cp $pointsFile_4thread $destPath/${TestCase}_4_BASELINE_${Node_num}.ini -f

pointsFile_4thread="$curPointsIniDir/${TestCase}_4thread_RESULT.ini"
\cp $pointsFile_4thread $destPath/${TestCase}_4_RESULT_${Node_num}.ini -f

pointsFile_4thread="$curPointsIniDir/${TestCase}_4thread_INDEX.ini"
\cp $pointsFile_4thread $destPath/${TestCase}_4_INDEX_${Node_num}.ini -f

#8线程
pointsFile_8thread="$curPointsIniDir/${TestCase}_8thread_BASELINE.ini"
\cp $pointsFile_8thread $destPath/${TestCase}_8_BASELINE_${Node_num}.ini -f

pointsFile_8thread="$curPointsIniDir/${TestCase}_8thread_RESULT.ini"
\cp $pointsFile_8thread $destPath/${TestCase}_8_RESULT_${Node_num}.ini -f

pointsFile_8thread="$curPointsIniDir/${TestCase}_8thread_INDEX.ini"
\cp $pointsFile_8thread $destPath/${TestCase}_8_INDEX_${Node_num}.ini -f

#16线程
pointsFile_16thread="$curPointsIniDir/${TestCase}_16thread_BASELINE.ini"
\cp $pointsFile_16thread $destPath/${TestCase}_16_BASELINE_${Node_num}.ini -f

pointsFile_16thread="$curPointsIniDir/${TestCase}_16thread_RESULT.ini"
\cp $pointsFile_16thread $destPath/${TestCase}_16_RESULT_${Node_num}.ini -f

pointsFile_16thread="$curPointsIniDir/${TestCase}_16thread_INDEX.ini"
\cp $pointsFile_16thread $destPath/${TestCase}_16_INDEX_${Node_num}.ini -f
