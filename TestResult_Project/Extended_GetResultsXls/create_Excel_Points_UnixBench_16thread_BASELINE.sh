...
TestCase="$3"
#----------------------------------------------------------------------------------------
TestSel="16" #TestSel 代表选择那一种线程测试
TestMode="BASELINE"
#----------------------------------------------------------------------------------------
...
python -c 'import write_Excel_UnixBench_16thread_BASELINE; write_Excel_UnixBench_16thread_BASELINE.writeResult("'$TestType'","'$Platform'","'$TestCase'","'$TestSel'","'$TestMode'","'$Node_count'")'
