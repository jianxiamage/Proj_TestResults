...
sh get_DetailInfo.sh $TestType $Platform "docker_namespace-net"
sh get_DetailInfo.sh $TestType $Platform "docker_namespace-pid"
...
sh get_DetailInfo.sh $TestType $Platform "luajit"
