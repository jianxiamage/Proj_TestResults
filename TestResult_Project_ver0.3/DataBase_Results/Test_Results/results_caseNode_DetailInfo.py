...
if __name__ == '__main__':
    ...
    try:
        ...
        #---------------------------------------------------------------------
        #创建数据表
        table_name = 'results_caseNode_DetailInfo_' + test_Tag
        table_caseNode_DetailInfo = 'caseNode_DetailInfo_' + test_Tag
        ...
        ''' %(table_name,table_results_BaseInfo,table_caseNode_DetailInfo,table_results_BaseInfo,table_caseNode_DetailInfo,table_results_BaseInfo,table_caseNode_DetailInfo,table_results_BaseInfo,table_caseNode_DetailInfo,table_results_BaseInfo)
        #---------------------------------------------------------------------
