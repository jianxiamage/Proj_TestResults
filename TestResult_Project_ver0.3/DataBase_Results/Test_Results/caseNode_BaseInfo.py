...
if __name__ == '__main__':
    ...
    try:
        ...
        #---------------------------------------------------------------------
        #创建数据表
        table_name = 'caseNode_BaseInfo_' + test_Tag
        ...
        create table if not exists %s (id int primary key auto_increment) 
        as select 
        case_BaseGroupInfo.case_name,%s.node_num,%s.IP,case_BaseGroupInfo.group_num 
        from  case_BaseGroupInfo right join %s on case_BaseGroupInfo.group_num = %s.group_num;
