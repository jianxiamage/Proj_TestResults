...
if __name__ == '__main__':
    ...
    try:
        ...
        as
        select Tag,node_num,compiler,compress,crypto,derby,mpegaudio,`scimark.large`,`scimark.small`,serial,startup,sunflow,xml,`Composite-result` from %s where Tag ='%s';
