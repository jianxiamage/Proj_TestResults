    ...
    def insertData_db(self, table_name, list_data):
        ...
        try:
            ...
            for line in list_data:
                 ...
                 sql = '''
                 insert into %s(Tag,node_num,compiler,compress,crypto,derby,mpegaudio,`scimark.large`,`scimark.small`,serial,startup,sunflow,xml,`Composite-result`) values('%s','%s', '%s', '%s', '%s', '%s','%s', '%s', '%s', '%s','%s', '%s', '%s', '%s')
                 '''  % (table_name,line[0],line[1],line[2],line[3],line[4],line[5],line[6],line[7],line[8],line[9],line[10],line[11],line[12],line[13])
