    ...
    def insertData_db(self, table_name, list_data):
        ...
        try:
            ...
            for line in list_data:
                 ...
                 sql = '''
                 insert into %s(Tag,node_num,`168.wupwise`,`171.swim`,`172.mgrid`,`173.applu`,`177.mesa`,`178.galgel`,`179.art`,`183.equake`,`187.facerec`,`188.ammp`,`189.lucas`,`191.fma3d`,`200.sixtrack`,`301.apsi`,SPECfp_rate_base2000) values('%s','%s', '%s', '%s', '%s', '%s','%s','%s', '%s', '%s', '%s', '%s','%s','%s', '%s', '%s', '%s')
