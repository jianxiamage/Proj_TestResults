    ...
    def insertData_db(self, table_name, list_data):
        ...
        try:
            ...
            for line in list_data:
                 sql = '''
                 insert into %s(Tag,node_num,`410.bwaves`,`416.gamess`,`433.milc`,`434.zeusmp`,`435.gromacs`,`436.cactusADM`,`437.leslie3d`,`444.namd`,`447.dealII`,`450.soplex`,`453.povray`,`454.calculix`,`459.GemsFDTD`,`465.tonto`,`470.lbm`,`481.wrf`,`482.sphinx3`,SPECfp_base2006) values('%s','%s','%s','%s','%s', '%s', '%s', '%s', '%s','%s','%s', '%s', '%s', '%s', '%s','%s','%s', '%s', '%s', '%s')
