    ...
    def insertData_db(self, table_name, list_data):
        ...
        try:
            ...
            for line in list_data:
                 sql = '''
                 insert into %s(Tag,node_num,`400.perlbench`,`401.bzip2`,`403.gcc`,`429.mcf`,`445.gobmk`,`456.hmmer`,`458.sjeng`,`462.libquantum`,`464.h264ref`,`471.omnetpp`,`473.astar`,`483.xalancbmk`,SPECint_base2006) values('%s','%s', '%s', '%s', '%s', '%s','%s','%s', '%s', '%s', '%s', '%s','%s','%s', '%s')
