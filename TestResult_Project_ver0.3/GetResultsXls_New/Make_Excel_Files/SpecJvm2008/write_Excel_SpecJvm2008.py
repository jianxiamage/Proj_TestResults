...
def writeResult(TestType,Platform,TestCase,count):
    ...
    ExcelPath = ResultPath + str(TestType) + '/' + str(Platform) + '/' + str(detailDir) + '/' + str(TestCase) + '/' + str(PointsPath) + '/' + str(TestCase) +  '_' + str(Platform) + '_' + str(TestType) + '.xls' 
    print IniPath
    print ExcelPath
    ...
    for i in range(1,countNum):
       print '第%d个节点' %(i)
       ResultIniPath = str(ResultPath) + str(TestType) + '/' + str(Platform) + '/' + str(detailDir) + '/' + str(TestCase) + '/' + str(PointsPath) + '/' + str(TestCase) + '_' +  str(i) + '.ini' 
       print ResultIniPath
