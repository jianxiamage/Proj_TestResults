...
python -c 'import write_Excel_UnixBench_1thread_INDEX; write_Excel_UnixBench_1thread_INDEX.writeResult("'$TestType'","'$Platform'","'$TestCase'","'$TestSel'","'$TestMode'","'$Node_count'")'
