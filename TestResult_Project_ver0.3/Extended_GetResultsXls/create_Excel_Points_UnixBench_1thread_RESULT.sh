...
python -c 'import write_Excel_UnixBench_1thread_RESULT; write_Excel_UnixBench_1thread_RESULT.writeResult("'$TestType'","'$Platform'","'$TestCase'","'$TestSel'","'$TestMode'","'$Node_count'")'
