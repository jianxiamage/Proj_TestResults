...
python -c 'import write_Excel_UnixBench_16thread_INDEX; write_Excel_UnixBench_16thread_INDEX.writeResult("'$TestType'","'$Platform'","'$TestCase'","'$TestSel'","'$TestMode'","'$Node_count'")'
