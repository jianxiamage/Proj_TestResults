...
if __name__ == '__main__':
  ...
  try:
      ...
      output = html.HTML_TMPL % dict(table_tr_1=table_td_1,table_tr_UnixBench = table_tr0,case_name=test_case,table_iozone=table_iozone,table_stream=table_stream,table_2=table_2,table_SpecJvm2008=table_SpecJvm2008)
