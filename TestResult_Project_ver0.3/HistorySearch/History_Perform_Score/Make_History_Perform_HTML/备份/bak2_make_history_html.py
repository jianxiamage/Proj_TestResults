...
if __name__ == '__main__':
  ...
  try:
      ...
      case_one = 'iozone'
      path_one = '/Results/Server/7A_2way/OS/Search/performScore'
      table_td_1 = html.TABLE_TMPL_TOTAL_1 % dict(case_name=case_one,href_path=path_one)

      table_td_2 = ''
      list_spec2000_1core = ['CFP', 'CINT']
      for name in list_spec2000_1core:
           name_all = 'spec2000单核:[' + name + ']'
           print('-------k-------------------')
           input_path = web_Path + class_type + '/' + backup_path + '/' + test_platform + '/' + test_type + '/' + k + '/Detail/LogInfo/' + test_case
           print('---------------------------')
           table_td = html.TABLE_TMPL_TOTAL_2 % dict(case_name_2=name_all,href_path_2=input_path)
           table_td_2 += table_td


      output = html.HTML_TMPL % dict(table_tr_1=table_td_1,table_tr_2=table_td_2,table_tr = table_tr0,table_tr2=table_tr1,table_tr3=table_tr2,case_name=test_case)
