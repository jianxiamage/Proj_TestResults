...
"stream")
    ...
    #stream单核测试
    sh get_history_html_stream.sh $TestType $Platform $class_type $TestCase
    retCode=$?
...
"spec2000-1core")
    ...
    sh get_history_html_spec2000_1core.sh $TestType $Platform $class_type $TestCase
    retCode=$?
...
"spec2000-ncore")
    ...
    sh get_history_html_spec2000_ncore.sh $TestType $Platform $class_type $TestCase
    retCode=$?
...
"spec2006-1core")
    ...
    sh get_history_html_spec2006_1core.sh $TestType $Platform $class_type $TestCase
    retCode=$?
...
"spec2006-ncore")
    ...
    #spec2006多核浮点型及整型测试结果
    sh get_history_html_spec2006_ncore.sh $TestType $Platform $class_type $TestCase
    retCode=$?
...
"SpecJvm2008")
    ...
    echo $cmdStr
    #SpecJvm2008测试
    sh get_history_html_SpecJvm2008.sh $TestType $Platform $class_type $TestCase
    retCode=$?
