...
if __name__ == '__main__':
  ...
  try:
      ...
      #生成html文件
      output = html.HTML_TMPL % dict(table_tr_Head = table_tr0,table_tr_Content=table_tr1,test_class=class_type,test_type=test_type,test_plat=test_platform,case_name=test_case_detail,node_num=node_num)
