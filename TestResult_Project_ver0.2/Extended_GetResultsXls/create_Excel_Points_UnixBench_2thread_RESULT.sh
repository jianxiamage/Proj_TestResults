...
python -c 'import write_Excel_UnixBench_2thread_RESULT; write_Excel_UnixBench_2thread_RESULT.writeResult("'$TestType'","'$Platform'","'$TestCase'","'$TestSel'","'$TestMode'","'$Node_count'")'
