...
python -c 'import write_Excel_UnixBench_2thread_BASELINE; write_Excel_UnixBench_2thread_BASELINE.writeResult("'$TestType'","'$Platform'","'$TestCase'","'$TestSel'","'$TestMode'","'$Node_count'")'
